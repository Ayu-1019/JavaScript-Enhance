...
class YuPromise {
  ...
  static resolve(value) {
    return new YuPromise((resolve) => resolve(value))
  }

  static reject(reason) {
    return new YuPromise((resolve, reject) => reject(reason))
  }
...
YuPromise.race([p1, p2, p3]).then(res => {
  console.log("res:", res)
}).catch(err => {
  console.log("err:", err)
})

// YuPromise.any([p1, p2, p3]).then(res => {
//   console.log("res:", res)
// }).catch(err => {
